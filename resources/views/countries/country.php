      ...
      <div class="col-12 col-sm-12 col-md-12">
         ...
         <div class="row">
            <div class="col-12 col-sm-12 col-md-12">
               ...
               <div class="mt-4">
                  <h1 class="title h2 mb-0">País <span class=" subtitle fs-5 fw-normal ms-2">Consulta y edita la información de los paises
                     </span></h1>
         ...
         <!-- Modal -->
         <div class="modal fade" id="countryModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="countryModalLabel">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h1 class="modal-title fs-5" id="countryModalLabel">Editar información</h1>
