<div class="pe-5 ps-5">
    <div>
        <div>
            <div class="mt-4">
                <h1 class="title h3 fw-bold  mb-0">Presupuesto meta <span class=" subtitle fs-5 fw-normal ms-2">Consulta los presupuestos con la meta anual de venta</span></h1>
    ...
    <div class="container-fluid py-3 mb-5">
        <div class="row g-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <div class="card stat-card bg-success overflow-hidden rounded-4 border-0" data-target="#metaTable2" style="cursor: pointer;">
            ...
            <!-- CLIENTES -->
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <div class="card stat-card bg-success overflow-hidden rounded-4 border-0" data-target="#custumerTable2" style="cursor: pointer;">
            ...
            <!-- PRESUPUESTADOS -->
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <div class="card stat-card bg-success overflow-hidden rounded-4 border-0" data-target="#budgetTable2" style="cursor: pointer;">
            ...
            <!-- No presupuestado -->
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <div class="card stat-card bg-success overflow-hidden rounded-4 border-0" data-target="#noBudgetTable2" style="cursor: pointer;">
            ...
            <!-- Por facturar -->
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <div class="card stat-card bg-success overflow-hidden rounded-4 border-0" data-target="#invoiceTable2" style="cursor: pointer;">
            ...
            <!-- este mes -->
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <div class="card stat-card bg-success overflow-hidden rounded-4 border-0" data-target="#thisMonthTable2" style="cursor: pointer;">
    ...
    <div class="border-bottom border-3 mb-4">
        <h1 class="title h3 fw-bold  mb-0 d-flex justify-content-between ">Clientes vendidos 2026 <span class=" subtitle fs-5  ms-2">Monto de venta: $6,862,371.70</span></h1>
    </div>
    ...
    <div class="table-responsive tabla-dinamica">
        <table id="metaTable2" class="table table-bordered table-striped align-middle mb-0 text-secondary ">
    ...
    <div class="table-responsive tabla-dinamica d-none">
        <table id="custumerTable2" class="table table-bordered table-striped align-middle mb-0 text-secondary ">
    ...
    <div class="table-responsive tabla-dinamica d-none">
        <table id="budgetTable2" class="table table-bordered table-striped align-middle mb-0 text-secondary ">
    ...
    <div class="table-responsive tabla-dinamica d-none">
        <table id="noBudgetTable2" class="table table-bordered table-striped align-middle mb-0 text-secondary ">
    ...
    <div class="table-responsive tabla-dinamica d-none">
        <table id="invoiceTable2" class="table table-bordered table-striped align-middle mb-0 text-secondary ">
    ...
    <div class="table-responsive tabla-dinamica d-none">
        <table id="thisMonthTable2" class="table table-bordered table-striped align-middle mb-0 text-secondary ">
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalSendReportAwards2">
    Launch static backdrop modal
</button>

<!-- MODAL PRINCIPAL COMPLETO -->
<div class="modal fade" id="modalSendReportAwards2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalPresupuestoLabel" aria-hidden="true">
