      ...
      <div class="col-12 col-sm-12 col-md-12">
         ...
         <div class="row">
            <div class="col-12 col-sm-12 col-md-12">
               ...
               <div class="mt-4">
                  <h1 class="title h2 mb-0">Productos <span class=" subtitle fs-5 fw-normal ms-2">Consulta de datos de productos</span></h1>
         ...
         <!-- Modal -->
         <div class="modal fade" id="productModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="productModalLabel">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h1 class="modal-title fs-5" id="productModalLabel">Editar información</h1>
                  ...
                  <div class="modal-body">
                     <form>
                        <div class="mb-3">
                           <label for="name" class="form-label">Cambiar nombre o descripción</label>
