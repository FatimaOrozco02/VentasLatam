      ...
      <div class="col-12 col-sm-12 col-md-12">
         ...
         <div class="row">
            <div class="col-12 col-sm-12 col-md-12">
               ...
               <div class="mt-4">
                  <h1 class="title h2 mb-0">Estado <span class=" subtitle fs-5 fw-normal ms-2">Consulta y edita la información de los estados
                     </span></h1>
         ...
         <div class="modal fade" id="stateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="stateModalLabel">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h1 class="modal-title fs-5" id="stateModalLabel">Editar información</h1>
